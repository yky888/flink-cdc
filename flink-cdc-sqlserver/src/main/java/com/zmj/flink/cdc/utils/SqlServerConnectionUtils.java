...
package com.zmj.flink.cdc.utils;

import io.debezium.config.Configuration;
import io.debezium.connector.sqlserver.*;
...
public class SqlServerConnectionUtils {
    ...
    public static void main(String[] args) throws Exception{
        ...
        props.setProperty("database.hostname", "172.31.3.96");
        ...
        props.setProperty("database.dbname", "SPxSSC");



//        prop.put("hostname","172.31.3.96");
//        prop.put("database","SPxSSC");
//        prop.put("port",1433);
//        prop.put("username","sa");
//        prop.put("password","Aa123456");
        Configuration configuration = Configuration.from(props);
        SqlServerConnection sqlServerConnection = SqlServerConnectionUtils.createSqlServerConnection(configuration);
        Set<SqlServerChangeTable> sqlServerChangeTables = sqlServerConnection.listOfChangeTables();
        System.out.println(sqlServerChangeTables);
    }
