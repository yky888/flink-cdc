...
package com.zmj.flink.cdc.parse;
...
public class JsonDebeziumSchemaSerializerSelf implements DorisRecordSerializer<String> {
    ...
    private SqlServerCdcSource sqlServerCdcSource;

    private static final SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

    public JsonDebeziumSchemaSerializerSelf(DorisOptions dorisOptions, Pattern pattern, String sourceTableName,SqlServerCdcSource sqlServerCdcSource) {
        ...
        this.sqlServerCdcSource = sqlServerCdcSource;
    }
    ...
    public byte[] serialize(String record) throws IOException {
        ...
        if (Objects.isNull(op)) {
            ...
            for(TableDesc tableDesc :ddl){
                ...
                if(DorisMetadataConsts.SQLSERVER_DATE_TYPE_LIST.contains(columnType)){
                    String columnName = tableDesc.getColumnName();
                    Object res = valueMap.get(columnName);
                    if(res==null || "null".equals(res)){
                        continue;
                    }
                    Long time = Long.valueOf(res + "");
                    String timeStr = sdf.format(new Date(time-28800000L));
                    valueMap.put(columnName,timeStr);
    ...
    public static JsonDebeziumSchemaSerializerSelf.Builder builder() {
        return new JsonDebeziumSchemaSerializerSelf.Builder();
    }
    ...
    public static class Builder {
        ...
        public JsonDebeziumSchemaSerializerSelf.Builder setSqlServerCdcSource(SqlServerCdcSource sqlServerCdcSource) {
            this.sqlServerCdcSource = sqlServerCdcSource;
            return this;
        }
        ...
        public JsonDebeziumSchemaSerializerSelf.Builder setDorisOptions(DorisOptions dorisOptions) {
            this.dorisOptions = dorisOptions;
            return this;
        }

        public JsonDebeziumSchemaSerializerSelf.Builder setPattern(Pattern addDropDDLPattern) {
            this.addDropDDLPattern = addDropDDLPattern;
            return this;
        }

        public JsonDebeziumSchemaSerializerSelf.Builder setSourceTableName(String sourceTableName) {
            this.sourceTableName = sourceTableName;
            return this;
        }

        public JsonDebeziumSchemaSerializerSelf build() {
            return new JsonDebeziumSchemaSerializerSelf(this.dorisOptions, this.addDropDDLPattern, this.sourceTableName,this.sqlServerCdcSource);
        }
    }
}
